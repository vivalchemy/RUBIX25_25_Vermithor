...
import { StarIcon, Clock, Users, ChevronRight, ShoppingCart, ShoppingBasket } from "lucide-react"
            ...
            <div className="sm:flex items-start p-4 gap-6">
              ...
              <div className="flex-grow gap-4">
                ...
                <div className="flex items-center pt-2 justify-between">
                  ...
                  <Button variant="outline" className="shrink-0"><ShoppingBasket />Add to Basket</Button>
                </div>
              </div>
            </div>
          </Card>
