...
function ProductDetails({ product, handleAddToCart }: { product: ProductType, handleAddToCart: (product: ProductType) => void }) {
      ...
      <div className="space-y-6 lg:py-4">
        <div className="space-y-3">
          <div className="flex items-center gap-2 text-gray-600">
            <span className="text-base">{product.vendor}</span>
